...
On peut dire qu'on a réécrit la formule avec la substitution $\left[l\leftarrow0\right]$. Par contre, il faut faire attention : si j'avais appellé ma limite $n_0$, j'aurais obtenu une formule qui n'a plus de sens, car $n_0$ \underline{est lié dans la formule}.
